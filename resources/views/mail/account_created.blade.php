                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>
                     ...
                     An <b>Order Management System</b> account has been created for you.<br/>

                     Login URL: <a href="{{env('SPA_APP')}}/login">{{env('SPA_APP')}}/login</a><br/>
                     Account Email: {{$account->email}}<br/>

                     <br/>
                     <br/>
                     If you have forgotten your password then visit here:
                      {{env('SPA_APP')}}/forgot_password
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <a href="{{env('SPA_APP')}}#/login" class="button button--green">Login</a>
